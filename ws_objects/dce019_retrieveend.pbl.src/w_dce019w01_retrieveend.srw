$PBExportHeader$w_dce019w01_retrieveend.srw
forward
global type w_dce019w01_retrieveend from window
end type
type cb_retrieve from commandbutton within w_dce019w01_retrieveend
end type
type cb_insert from commandbutton within w_dce019w01_retrieveend
end type
type cb_delete from commandbutton within w_dce019w01_retrieveend
end type
type dw_1 from datawindow within w_dce019w01_retrieveend
end type
type cb_clear from commandbutton within w_dce019w01_retrieveend
end type
type cb_save from commandbutton within w_dce019w01_retrieveend
end type
type cb_close from commandbutton within w_dce019w01_retrieveend
end type
type mle_output from multilineedit within w_dce019w01_retrieveend
end type
type mle_view from multilineedit within w_dce019w01_retrieveend
end type
type lb_items from listbox within w_dce019w01_retrieveend
end type
type gb_3 from groupbox within w_dce019w01_retrieveend
end type
type gb_4 from groupbox within w_dce019w01_retrieveend
end type
type gb_5 from groupbox within w_dce019w01_retrieveend
end type
type mle_describe from multilineedit within w_dce019w01_retrieveend
end type
type gb_1 from groupbox within w_dce019w01_retrieveend
end type
type gb_2 from groupbox within w_dce019w01_retrieveend
end type
end forward
...
string title = "DataWindow RetrieveEnd Event"
...
global w_dce019w01_retrieveend w_dce019w01_retrieveend
...
mle_describe.text += "2.Testing Purpose : DataWindow RetrieveEnd Event " // This must include
...
lb_items.additem("DCE019W01P001: DataWindow Retrieve With No Data Result")
lb_items.additem("DCE019W01P002: DataWindow Retrieve With One Row Result")
lb_items.additem("DCE019W01P003: DataWindow Retrieve With Multi Rows Result")
...
Choose Case ls_item
	Case 'DCE019W01P001'
		if ab_execute then
			//DataWindow Retrieve With No Data Result
			Wf_output('Test Point: ' + ls_item,true)
			Wf_output('Describe  : ' + ls_descript,False)
			dw_1.dataobject = 'd_dce019w01p001_column'
	...
	Case 'DCE019W01P002'
		if ab_execute then
			//DataWindow Retrieve With One Row Result
			Wf_output('Test Point: ' + ls_item,true)
			Wf_output('Describe  : ' + ls_descript,False)
			dw_1.dataobject = 'd_dce019w01p002_column'
			dw_1.setTransObject(sqlca)
			dw_1.Retrieve()
		else
	...
	Case 'DCE019W01P003'
		if ab_execute then
			//DataWindow Retrieve With Multi Rows Result
			Wf_output('Test Point: ' + ls_item,true)
			Wf_output('Describe  : ' + ls_descript,False)
			dw_1.dataobject = 'd_dce019w01p003_column'
			dw_1.setTransObject(sqlca)
			dw_1.Retrieve()
		else
...
on w_dce019w01_retrieveend.create
...
on w_dce019w01_retrieveend.destroy
...
integer taborder = 20
string title = "none"
string dataobject = "d_dce019w01_column"
...
event retrieveend;string ls_output

ls_output = string(mle_output.LineCount(),'00')+' '+"Information: RetrieveEnd "+" (rowcount = "+string(rowcount) + ")"
